                    ...
                    <div class="dropdown d-flex">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            <a class="dropdown-item" href="#"><img class="w20 mr-2"
                                                                   src={{asset('admin/assets/images/flags/us.png')}}>English</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="#"><img class="w20 mr-2"
                                                                   src={{asset('admin/assets/images/flags/ar.png')}}>Arabic</a>
                        </div>
                    </div>
                    <div class="dropdown d-flex">
                        <a class="nav-link icon d-none d-md-flex btn btn-default btn-icon ml-2"
                                ...
                                <li class="online">
                                    <a href="javascript:void(0);" class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="message">There are many variations of passages of Lorem
                                                Ipsum
                                            </div>
