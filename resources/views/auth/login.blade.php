            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="email"
                               class="col-md-8 col-form-label text-md-end">{{ __('Email Address') }}</label>
                    ...
                    <div class="form-group">
                        <label for="password"
                               class="col-md-12 col-form-label text-md-end">{{ __('Password') }}<a href="forgot-password.html" class="float-right small">I
